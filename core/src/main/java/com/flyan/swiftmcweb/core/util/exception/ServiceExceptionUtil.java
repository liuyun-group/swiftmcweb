package com.flyan.swiftmcweb.core.util.exception;
...
public class ServiceExceptionUtil {
    ...
    public static ServiceException exception(ErrorCode errorCode) {
        String messagePattern = MESSAGES.getOrDefault(errorCode.getErrcode(), errorCode.getMsg());
        return exception0(errorCode.getErrcode(), messagePattern);
    }

    public static ServiceException exception(ErrorCode errorCode, Object... params) {
        String messagePattern = MESSAGES.getOrDefault(errorCode.getErrcode(), errorCode.getMsg());
        return exception0(errorCode.getErrcode(), messagePattern, params);
    }
