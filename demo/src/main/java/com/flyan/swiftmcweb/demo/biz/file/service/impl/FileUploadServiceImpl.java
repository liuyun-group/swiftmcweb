package com.flyan.swiftmcweb.demo.biz.file.service.impl;
...
import static com.flyan.swiftmcweb.demo.biz.common.enums.ErrorCodeConstants.*;
...
public class FileUploadServiceImpl implements FileUploadService {
    ...
    public String uploadFile(MultipartFile uploadFile) {
        ...
        if(!fileDir.exists() && !fileDir.mkdirs()) {
            ...
            throw exception(ERR_DIR_CREAT_FAILED, fileDir.getParentFile());
        }
        ...
        try {
            ...
            throw exception(ERR_SAVE_UPLOAD_FILE_FAILED, e.getMessage());
        }
    }
